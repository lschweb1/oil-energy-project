...
**Results:** Generated metric files (e.g. JSON outputs) are reproducible and can be regenerated by running `main.py`.

---

## Requirements

See `requirements.txt` for the exact pinned Python dependencies used to run the reproducible pipeline and tests.
